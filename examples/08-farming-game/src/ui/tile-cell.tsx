...
export const TileCell = memo<TileCellProps>(
  ({ x, y, tile, occupant, isSelected, onClick }) => {
    ...
    return (
      <button
        className={cn(
          "relative size-full flex items-center justify-center cursor-pointer transition-all duration-200 aspect-square border-foreground/40 border group contain-strict",
